...
<div class="login-box">
  <div class="login-logo">
    <a href="{{url('/')}}/assets/admin/index2.html"><b>Admin</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Oturumu Aç</p>
      ...
      <div class="social-auth-links text-center mb-3">
        ...
        <a href="#" class="btn btn-block btn-primary">
          <i class="fab fa-facebook mr-2"></i> Facebook ile bağlan
        </a>
        <a href="#" class="btn btn-block btn-danger">
          <i class="fab fa-google-plus mr-2"></i> Google+ ile bağlan
        </a>
      </div>
      <!-- /.social-auth-links -->

      <p class="mb-1">
        <a href="forgot-password.html">Şifremi hatırla</a>
      </p>
      <p class="mb-0">
